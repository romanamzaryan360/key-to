...
export const MOBILE_MAX_SIZE: number = 599;
export const MOBILE_MIN_SIZE: number = 390;
export const MOBILE_CONTAINER_SIZE: number = 358;

export const UNSAFE_MOBILE_DEVICE = "unsafe";
export const UNSAFE_MOBILE_MAX_SIZE: number = 389;
